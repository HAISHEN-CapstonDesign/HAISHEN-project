...
export default {
    created(){
        ...
        axios    
            .post('http://localhost:3000/api/getpostlist', { genre: '경제' }, { headers: {'token': localStorage.getItem('access_token')}})
                .then(res => {
        ...
        axios    
            .post('http://localhost:3000/api/getrecruitingPost', { genre: '경제' }, { headers: {'token': localStorage.getItem('access_token')}})
                .then(res => {
