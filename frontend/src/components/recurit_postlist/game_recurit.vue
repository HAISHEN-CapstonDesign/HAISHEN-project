...
export default {
     created(){
        ...
        axios    
            .post('http://localhost:3000/api/getpostlist', { genre: '게임' }, { headers: {'token': localStorage.getItem('access_token')}})
                .then(res => {
        ...
        axios    
            .post('http://localhost:3000/api/getrecruitingPost', { genre: '게임' }, { headers: {'token': localStorage.getItem('access_token')}})
                .then(res => {
