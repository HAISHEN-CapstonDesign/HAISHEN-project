...
export default {
     created(){
        ...
        // axios    
        //     .post('http://localhost:3000/api/getpostlist', { genre: '역사' }, { headers: {'token': localStorage.getItem('access_token')}})
        //         .then(res => {
        ...
        axios    
            .post('http://localhost:3000/api/getrecruitingPost', { genre: '역사' }, { headers: {'token': localStorage.getItem('access_token')}})
                .then(res => {
    ...
    data(){
        return{
            ...
            bookList: [
                {
                    title:'매일 아침, 역사와 마주합니다.',
                    info:'매일 아침, 역사와 마주합니다.',
                    src: require('../../assets/contents_picture/history_01.jpg'),
                    members: ['iam', 'ff'],
                    show: false,
                    like: 3,
                    subscribe: 2,
                ...
                {
                    title:'역사: 역사는 함부로 고칠 수 없다',
                    info:'역사: 역사는 함부로 고칠 수 없다',
                    src: require('../../assets/contents_picture/history_02.jpg'),
                    members: ['로도스로','거신상'],
                    show: false,
                    like: 48,
                    subscribe: 29,
