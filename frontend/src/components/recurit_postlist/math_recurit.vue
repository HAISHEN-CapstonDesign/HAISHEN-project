            ...
            bookList: [
                {
                    title:'틀리지 않는 법',
                    info:'틀리지 않는 법',
                    src: require('../../assets/contents_picture/math_xmffl.jpg'),
                    members: ['박인식'],
                    show: false,
                    like: 3,
                    subscribe: 2,
                },
                {
                    title:'수학 문제를 질문할 때',
                    info:'수학 문제를 질문할 때',
                    src: require('../../assets/contents_picture/math_question.jpg'),
                    members: ['안승준'],
                    show: false,
                    like: 48,
                    subscribe: 29,
                },
                {
                    title:'좀 재밌는 수학 이야기',
                    info:'좀 재밌는 수학 이야기',
                    src: require('../../assets/contents_picture/math_interesting.jpg'),
                    members: ['전형준'],
                    show: false,
                    like: 33,
                    subscribe: 21,
