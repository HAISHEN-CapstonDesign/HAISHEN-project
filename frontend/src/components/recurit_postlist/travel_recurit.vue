...
export default {
     created(){
        ...
        axios    
            .post('http://localhost:3000/api/getrecruitingPost', { genre: '여행' }, { headers: {'token': localStorage.getItem('access_token')}})
                .then(res => {
        ...
        return{
            ...
            bookList: [
                ...
                },
                {
                    ...
                    info:'스페인 최고의 휴양지, 말라가',
                    src: require('../../assets/contents_picture/trave_spain.jpg'),
                    members: ['금선','ggol'],
                    show: false,
                    like: 48,
                    subscribe: 29,
