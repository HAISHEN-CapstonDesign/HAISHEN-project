...
\n그러던 중 저는 작가분들과 함께 이것에 대해 구체적으로 글로 작성해보면 어떨까 생각하게 되었어요. 분명 독자분들도 알게 되면 좋은 것들로 글이 구성이 될것 같아요. 기획자 분들에게 도움 될 만한 정보, 기획자가 되고 싶은 분들께도 분명 좋은 정보가 되는 글 일 겁니다.`
                    }
                    else{
